package com.aditgudhel.sijempol.ui
...
import com.aditgudhel.sijempol.ui.auth.LoginFragment
    ...
    when {
        ...
        failure.errorCode == 401 -> {
            if (this is LoginFragment) {
                requireView().snackbar("You've entered incorrect username or passowrd")
            } else {
